...
pub static BLEND_MULTIPLY: NodeTypeDefinition = NodeTypeDefinition {
    ...
    create_pins: || vec![
        Pin::input("a", "A", PinType::Color).with_default(PinValue::Color([1.0, 1.0, 1.0, 1.0])),
        Pin::input("b", "B", PinType::Color).with_default(PinValue::Color([1.0, 1.0, 1.0, 1.0])),
        Pin::output("result", "Result", PinType::Color),
    ],
...
pub static BLEND_SCREEN: NodeTypeDefinition = NodeTypeDefinition {
    ...
    create_pins: || vec![
        Pin::input("a", "A", PinType::Color).with_default(PinValue::Color([0.0, 0.0, 0.0, 1.0])),
        Pin::input("b", "B", PinType::Color).with_default(PinValue::Color([0.0, 0.0, 0.0, 1.0])),
        Pin::output("result", "Result", PinType::Color),
    ],
    color: [180, 120, 200],
    is_event: false,
...
pub static BLEND_OVERLAY: NodeTypeDefinition = NodeTypeDefinition {
    ...
    create_pins: || vec![
        Pin::input("a", "A", PinType::Color).with_default(PinValue::Color([0.5, 0.5, 0.5, 1.0])),
        Pin::input("b", "B", PinType::Color).with_default(PinValue::Color([0.5, 0.5, 0.5, 1.0])),
        Pin::output("result", "Result", PinType::Color),
    ],
    color: [180, 120, 200],
    is_event: false,
