...
import { IconBox, IconSettings, IconFileText, IconX, IconStar, IconCopy, IconPlayerPlay, IconPlayerPause, IconPlus, IconGridDots } from '@tabler/icons-solidjs';
...
const ViewportTabs = () => {
  ...
  const getViewportIcon = (type) => {
    ...
    return viewportType ? viewportType.icon : IconFileText;
  };
