...
import { sceneStore, sceneActions } from '@/plugins/core/render/store';
import { viewportStore, viewportActions } from '@/plugins/editor/stores/ViewportStore';
import { propertiesPanelVisible, bottomPanelVisible } from '@/plugins/core/engine/EngineAPI';
import RightPanel from '@/plugins/editor/propertiesPanel/RightPanel';
import BottomPanel from './bottomPanel/BottomPanel';
import PanelToggleButton  from '@/plugins/editor/ui/PanelToggleButton';
import ContextMenu from '@/plugins/editor/ui/ContextMenu';
import TopBarMenu from '@/plugins/editor/ui/TopBarMenu';
import HorizontalToolbar from '@/plugins/editor/ui/HorizontalToolbar';
import ViewportContainer from '@/plugins/editor/viewports/ViewportContainer';
import { createPanelResize } from '@/plugins/editor/hooks/usePanelResize';
import { createContextMenuActions } from '@/plugins/editor/actions/ContextMenuActions';
...
const EditorPlugin = () => {
  ...
  const consoleState = () => editorStore.console;
  ...
  const contextMenuHandler = () => consoleState().contextMenuHandler;
  ...
  onMount(() => {
    ...
    const handleKeyDown = (e) => {
      if (e.code === 'Space' && !e.target.matches('input, textarea, [contenteditable]')) {
        ...
        setAssetPanelOpen(!currentState);
      }
    };
...
export { default as EditorPluginClass } from './EditorPluginClass.jsx';