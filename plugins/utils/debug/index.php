  ...
  <div class='window position-fixed bottom-0 right-2' style='width: 250px;background: #bba229; margin-bottom: 10px;'>
    ...
    <div class='position-relative'>
      <div class='container text-light window_body p-2'>
        <button id='register_connect' onclick="plugin.load('debug/sprite_debug.php', 'sprite_debug_window');" class="green_button text-white font-bold py-3 px-4 rounded w-full mt-2 shadow-md">Sprite Debug</button>
