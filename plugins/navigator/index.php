...
?>
  <div class='window window_bg fixed bottom-2 left-1' style='width: 383px; height: 540px; background: #3d6a91; overflow: hidden;'>
    ...
    <div data-part='handle' class='window_title' style='background-image: radial-gradient(#363657 1px, transparent 0) !important;'>
      ...
      <div data-part='title' class='title_bg window_border' style='background: #3d6a91; color: #ede8d6;'>navigator</div>
    </div>
...
navigator_window = {
          ...
          tabs.forEach(tab => {
            tab.addEventListener('click', function() {
              ...
              if (contentDiv) {
                ...
                navigator.log(`plugins/navigator/tabs/${target}/index.php`);

                contentDiv.classList.remove('hidden');
                ui.ajax({
                  method: 'POST',
                  url: `plugins/navigator/tabs/${target}/index.php`,
        ...
        LeftTrigger: function() {
          navigator.log("left trigger called from navigator_window");
        },

        B: function() {
          plugin.close('navigator_window');
        },
