...
var ui_servers_tab_window = {
    ...
    openCreateServerModal: function() {
        modal.load('navigator/tabs/servers/createServer.php', 'server_create_window');
    },
    loadServers: function() {
        ui.ajax({
            outputType: 'json',
            method: 'POST',
            url: 'modals/navigator/tabs/servers/ajax/getServers.php',
            data: JSON.stringify({}),
            headers: {
    ...
    loadScenes: function(serverId) {
        ...
        ui.ajax({
            outputType: 'json',
            method: 'POST',
            url: 'modals/navigator/tabs/servers/ajax/getScenes.php',
    ...
    loadEditServerModal: function(serverId, serverName) {
        modal.load(`navigator/tabs/servers/editServer.php?id=${serverId}&name=${encodeURIComponent(serverName)}`, 'server_edit_window');
    },
    loadEditSceneModal: function(sceneId, sceneName, serverId) {
        modal.load(`navigator/tabs/servers/editScene.php?id=${sceneId}&name=${encodeURIComponent(sceneName)}&serverId=${serverId}`, 'scene_edit_window');
    },
    loadCreateSceneModal: function(serverId) {
        navigator.log('Loading create scene modal for serverId:', serverId);
        modal.load(`navigator/tabs/servers/createScene.php?id=${serverId}`, 'scene_create_window');
    },
    unmount: function() {
