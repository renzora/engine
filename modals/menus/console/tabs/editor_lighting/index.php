...
?>
    ...
    <div class="form-group">
        ...
        <select id="nightFilterCompositeOperation" class="form-control bg-gray-800 border-gray-600 text-white rounded mt-1" onchange="ui_console_editor_lighting.updateNightFilterCompositeOperation()">
            <option value="source-over">source-over</option>
            <option value="source-in">source-in</option>
            <option value="source-out">source-out</option>
            <option value="source-atop">source-atop</option>
            ...
            const lightControls = `
              <div class="light-item" style="background: #2D2D2D; padding: 10px; margin-bottom: 10px; border-radius: 5px;">
                <div class="form-group">
                  ...
                  <input type="range" id="lightRadius_${index}" class="form-control-range w-full mt-1 mb-2" min="10" max="1000" value="${lighting.lights.find(light => light.type === type).baseRadius}" oninput="ui_console_editor_lighting.updateLightTypeAndLabel('${type}', 'lightRadiusLabel_${index}', this.value, 'radius')">
                ...
                <div class="form-group">
                  ...
                  <input type="range" id="lightColorR_${index}" class="form-control-range w-full mt-1 mb-2" min="0" max="255" value="${lighting.lights.find(light => light.type === type).color.r}" oninput="ui_console_editor_lighting.updateLightTypeAndLabel('${type}', 'lightColorRLabel_${index}', this.value, 'colorR')">
                ...
                <div class="form-group">
                  ...
                  <input type="range" id="lightColorG_${index}" class="form-control-range w-full mt-1 mb-2" min="0" max="255" value="${lighting.lights.find(light => light.type === type).color.g}" oninput="ui_console_editor_lighting.updateLightTypeAndLabel('${type}', 'lightColorGLabel_${index}', this.value, 'colorG')">
                ...
                <div class="form-group">
                  ...
                  <input type="range" id="lightColorB_${index}" class="form-control-range w-full mt-1 mb-2" min="0" max="255" value="${lighting.lights.find(light => light.type === type).color.b}" oninput="ui_console_editor_lighting.updateLightTypeAndLabel('${type}', 'lightColorBLabel_${index}', this.value, 'colorB')">
                ...
                <div class="form-group">
                  ...
                  <input type="range" id="lightIntensity_${index}" class="form-control-range w-full mt-1 mb-2" min="0" max="1" step="0.01" value="${lighting.lights.find(light => light.type === type).maxIntensity}" oninput="ui_console_editor_lighting.updateLightTypeAndLabel('${type}', 'lightIntensityLabel_${index}', this.value, 'intensity')">
                ...
                <div class="form-group">
                  ...
                  <input type="checkbox" id="lightFlicker_${index}" ${lighting.lights.find(light => light.type === type).flicker ? 'checked' : ''} onchange="ui_console_editor_lighting.updateLightTypeAndLabel('${type}', 'lightFlickerLabel_${index}', this.checked, 'flicker')">
                ...
                <div class="form-group">
                  ...
                  <input type="range" id="lightFlickerSpeed_${index}" class="form-control-range w-full mt-1 mb-2" min="0" max="1" step="0.01" value="${lighting.lights.find(light => light.type === type).flickerSpeed}" oninput="ui_console_editor_lighting.updateLightTypeAndLabel('${type}', 'lightFlickerSpeedLabel_${index}', this.value, 'flickerSpeed')">
                ...
                <div class="form-group">
                  ...
                  <input type="range" id="lightFlickerAmount_${index}" class="form-control-range w-full mt-1 mb-2" min="0" max="1" step="0.01" value="${lighting.lights.find(light => light.type === type).flickerAmount}" oninput="ui_console_editor_lighting.updateLightTypeAndLabel('${type}', 'lightFlickerAmountLabel_${index}', this.value, 'flickerAmount')">
