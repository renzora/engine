...
if ($mode === 'editor') {
    ?>
   <button class="tab relative flex items-center justify-center w-full h-12 text-gray-600 hover:text-white hint--right px-2" data-tab="lighting" aria-label="Lighting">
