...
if ($mode === 'editor') {
    ?>
        <button class="console_tab relative flex items-center justify-center w-full h-12 text-gray-600 hover:text-white hint--right px-2" data-tab="editor" aria-label="Inventory">
      <div class="ui_icon ui_backpack"></div>
    </button>
    <button class="console_tab relative flex items-center justify-center w-full h-12 text-gray-600 hover:text-white hint--right px-2" data-tab="add" aria-label="Info">
      <div class="ui_icon ui_info"></div>
    </button>
   <button class="console_tab relative flex items-center justify-center w-full h-12 text-gray-600 hover:text-white hint--right px-2" data-tab="Pencil" aria-label="Weather">
      <div class="ui_icon ui_cloud"></div>
    </button>
    <button class="console_tab relative flex items-center justify-center w-full h-12 text-gray-600 hover:text-white hint--right px-2" data-tab="add" aria-label="Lighting">
      <div class="ui_icon ui_lightbulb"></div>
    </button>
    <button class="console_tab flex items-center justify-center w-full h-12 text-gray-600 hover:text-white hint--right px-2" data-tab="editor" aria-label="Music">
      <div class="ui_icon ui_music"></div>
    </button>
    <button class="console_tab relative flex items-center justify-center w-full h-12 text-gray-600 hover:text-white hint--right px-2" data-tab="add" aria-label="Scripting">
      <div class="ui_icon ui_script"></div>
    </button>
    <button class="console_tab relative flex items-center justify-center w-full h-12 text-gray-600 hover:text-white hint--right px-2" data-tab="add" aria-label="Permissions">
    ...
    <button class="relative flex items-center justify-center w-full h-12 text-gray-600 hover:text-white hint--right px-2" aria-label="Edit Mode" onclick="modal.load({ id: 'editor_window', url: 'editor/index.php', name: 'Editor', showInList: true });">
