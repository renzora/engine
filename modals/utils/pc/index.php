  ...
  <div data-window='pc_window' class='window bg-gray-800' style='width: 800px; height: 600px;'>
    ...
    <div class='relative window_body bg-gray-900'>
      ...
      <div class='desktop grid grid-cols-4 gap-4 p-4'>
        <div class='icon text-center cursor-pointer' onclick="pc_window.openModal('main_title_window', 'menus/main_title/index.php', 'Main Titles')">
          <div class='icon-image bg-gray-600 w-16 h-16 mx-auto rounded'></div>
          <span class='text-gray-300 text-sm'>Main Titles</span>
        </div>

        <div class='icon text-center cursor-pointer' onclick="pc_window.openModal('settings_window', 'menus/settings/index.php', 'Settings')">
          <div class='icon-image bg-gray-600 w-16 h-16 mx-auto rounded'></div>
    ...
    <script>
      var pc_window = {
        ...
        openModal: function(id, url, name) {
          modal.load({
            id: id,
            url: url,
            name: name,
