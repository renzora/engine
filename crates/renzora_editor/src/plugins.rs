...
pub(crate) fn add_editor_plugins(app: &mut App) {
    app.add_plugins(renzora_ai_chat::AiChatPlugin::default());
    ...
    app.add_plugins(renzora_collab::CollabPlugin::default());
    ...
    app.add_plugins(renzora_gamepad::GamepadPlugin::default());
    app.add_plugins(renzora_git::GitPlugin::default());
    ...
    app.add_plugins(renzora_mesh_draw::MeshDrawPlugin::default());
