...
pub fn vec2_edit(commands: &mut Commands, font: &Handle<Font>, x: f32, y: f32) -> Entity {
    let fields = [
...
pub fn vec4_edit(commands: &mut Commands, font: &Handle<Font>, x: f32, y: f32, z: f32, w: f32) -> Entity {
    let fields = [
        drag_value(commands, font, "X", X, x, 0.05),
        drag_value(commands, font, "Y", Y, y, 0.05),
        drag_value(commands, font, "Z", Z, z, 0.05),
