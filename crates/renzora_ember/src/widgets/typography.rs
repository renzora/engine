...
pub fn h1(commands: &mut Commands, font: &bevy::text::FontSource, text: &str) -> Entity {
    text_node(commands, font, text, 26.0, text_primary())
}
/// Heading, level 2.
pub fn h2(commands: &mut Commands, font: &bevy::text::FontSource, text: &str) -> Entity {
    text_node(commands, font, text, 21.0, text_primary())
}
/// Heading, level 3.
pub fn h3(commands: &mut Commands, font: &bevy::text::FontSource, text: &str) -> Entity {
    text_node(commands, font, text, 17.0, text_primary())
}
/// Heading, level 4 (smallest).
pub fn h4(commands: &mut Commands, font: &bevy::text::FontSource, text: &str) -> Entity {
    text_node(commands, font, text, 14.0, text_primary())
}
/// Body paragraph text.
pub fn paragraph(commands: &mut Commands, font: &bevy::text::FontSource, text: &str) -> Entity {
    text_node(commands, font, text, 13.0, text_primary())
}
/// Small, muted caption.
pub fn caption(commands: &mut Commands, font: &bevy::text::FontSource, text: &str) -> Entity {
    text_node(commands, font, text, 11.0, text_muted())
}
/// A muted form/field label.
pub fn label(commands: &mut Commands, font: &bevy::text::FontSource, text: &str) -> Entity {
    text_node(commands, font, text, 12.0, text_muted())
}

/// An accent-colored hyperlink (pointer cursor; click handling is the caller's).
pub fn link(commands: &mut Commands, font: &bevy::text::FontSource, text: &str) -> Entity {
    commands
        .spawn((
            Text::new(text),
            ui_font(font, 12.0),
...
pub fn code(commands: &mut Commands, font: &bevy::text::FontSource, text: &str) -> Entity {
    commands
        .spawn((
            Node {
