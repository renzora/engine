...
pub fn create_translation_track(bone_name: &str, keyframes: Vec<(f32, [f32; 3])>) -> BoneTrack {
    BoneTrack {
...
pub fn create_rotation_track(bone_name: &str, keyframes: Vec<(f32, [f32; 4])>) -> BoneTrack {
    BoneTrack {
        bone_name: bone_name.to_string(),
