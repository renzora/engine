...
impl PhysicsDebugPanel {
    fn new(bridge: Arc<Mutex<PhysicsBridgeInner>>) -> Self {
        Self {
            bridge,
            local: RwLock::new(PhysicsDebugState::default()),
        }
    }
}
...
impl EditorPanel for PhysicsDebugPanel {
    ...
    fn icon(&self) -> Option<&str> {
        Some(egui_phosphor::regular::ATOM)
    }
...
impl PhysicsPlaygroundPanel {
    fn new(bridge: Arc<Mutex<PhysicsBridgeInner>>) -> Self {
        Self {
            bridge,
            local: RwLock::new(PlaygroundState::default()),
        }
    }
}
...
impl PhysicsForcesPanel {
    fn new(bridge: Arc<Mutex<PhysicsBridgeInner>>) -> Self {
        Self {
            bridge,
            local: RwLock::new(ForcesState::default()),
        }
    }
}
...
impl EditorPanel for PhysicsForcesPanel {
    ...
    fn icon(&self) -> Option<&str> {
        Some(egui_phosphor::regular::LIGHTNING)
    }
    fn category(&self) -> &str {
        "Debug"
    }
...
impl PhysicsMetricsPanel {
    fn new(bridge: Arc<Mutex<PhysicsBridgeInner>>) -> Self {
        Self {
            bridge,
            local: RwLock::new(MetricsState::default()),
        }
    }
}
...
impl EditorPanel for PhysicsMetricsPanel {
    ...
    fn icon(&self) -> Option<&str> {
        Some(egui_phosphor::regular::CHART_LINE)
    }
    fn category(&self) -> &str {
        "Debug"
    }
...
impl PhysicsScenariosPanel {
    fn new(bridge: Arc<Mutex<PhysicsBridgeInner>>) -> Self {
        Self {
            bridge,
            local: RwLock::new(ScenariosState::default()),
        }
    }
}
...
impl EditorPanel for PhysicsScenariosPanel {
    ...
    fn icon(&self) -> Option<&str> {
        Some(egui_phosphor::regular::ROCKET_LAUNCH)
    }
    fn category(&self) -> &str {
        "Debug"
    }
...
impl ArenaPresetsPanel {
    fn new(bridge: Arc<Mutex<PhysicsBridgeInner>>) -> Self {
        Self {
            bridge,
            local: RwLock::new(ArenaPresetsState::default()),
        }
    }
}
            ...
            PlaygroundCommand::Spawn => {
                ...
                for (i, pos) in positions.iter().enumerate() {
                    ...
                    let entity = commands
                        ...
                        .id();
                    renzora_physics::spawn_entity_physics(
                        &mut commands,
                        entity,
                        Some(&body_data),
                        Some(&collision),
...
fn spawn_bowling(
    ...
    spawn_pg(
        commands,
        lane_mesh,
        mat(materials, Color::srgb(0.6, 0.45, 0.25)),
        "Lane".into(),
        Transform::from_translation(Vec3::new(0.0, -0.05, 0.0)),
        PhysicsBodyType::StaticBody,
        CollisionShapeData::cuboid(Vec3::new(1.5 * s, 0.05, 10.0 * s)),
        1.0,
    );
    ...
    for (i, (x, z)) in pin_positions.iter().enumerate() {
        spawn_pg(
            ...
            CollisionShapeData::capsule(0.12 * s, 0.25 * s),
            0.3,
        );
    }
    ...
    spawn_pg(
        commands,
        ball_mesh,
        mat(materials, Color::srgb(0.15, 0.15, 0.5)),
        "Bowling Ball".into(),
        Transform::from_translation(Vec3::new(0.0, 0.3 * s, -8.0 * s)),
        PhysicsBodyType::RigidBody,
        CollisionShapeData::sphere(0.3 * s),
        6.0,
    );
    ...
    for side in [-1.0f32, 1.0] {
        ...
        spawn_pg(
            commands,
            gutter_mesh,
            mat(materials, Color::srgb(0.3, 0.3, 0.3)),
            "Gutter".into(),
            Transform::from_translation(Vec3::new(side * 1.6 * s, 0.1 * s, 0.0)),
            PhysicsBodyType::StaticBody,
            CollisionShapeData::cuboid(Vec3::new(0.1 * s, 0.15 * s, 10.0 * s)),
            1.0,
        );
    }
...
fn spawn_catapult(
    ...
    spawn_pg(
        commands,
        base_mesh,
        mat(materials, Color::srgb(0.4, 0.3, 0.2)),
        "Catapult Base".into(),
        Transform::from_translation(Vec3::new(-5.0 * s, 0.25 * s, 0.0)),
        PhysicsBodyType::StaticBody,
        CollisionShapeData::cuboid(Vec3::new(1.0 * s, 0.25 * s, 1.0 * s)),
        1.0,
    );
    ...
    spawn_pg(
        commands,
        arm_mesh,
        mat(materials, Color::srgb(0.5, 0.35, 0.15)),
        "Catapult Arm".into(),
        Transform::from_translation(Vec3::new(-5.0 * s, 1.5 * s, 0.0))
            .with_rotation(Quat::from_rotation_x(-0.5)),
        PhysicsBodyType::RigidBody,
        CollisionShapeData::cuboid(Vec3::new(0.15 * s, 0.1 * s, 3.0 * s)),
        3.0,
    );
    ...
    spawn_pg(
        commands,
        proj_mesh,
        mat(materials, Color::hsl(15.0, 0.9, 0.5)),
        "Catapult Projectile".into(),
    ...
    spawn_pg(
        commands,
        wall_mesh,
        mat(materials, Color::hsl(0.0, 0.5, 0.5)),
        "Target Wall".into(),
        Transform::from_translation(Vec3::new(8.0 * s, 1.5 * s, 0.0)),
        PhysicsBodyType::StaticBody,
        CollisionShapeData::cuboid(Vec3::new(0.25 * s, 1.5 * s, 2.0 * s)),
        1.0,
    );
    ...
    for i in 0..6u32 {
        ...
        spawn_pg(
            commands,
            box_mesh.clone(),
            mat(materials, Color::hsl(i as f32 * 50.0, 0.7, 0.6)),
            format!("Target Box {}", i),
            ...
            PhysicsBodyType::RigidBody,
            CollisionShapeData::cuboid(Vec3::splat(0.4 * s)),
            1.0,
        );
    }
    spawn_ground(commands, meshes, materials, s);
...
fn spawn_balancing_act(
    ...
    spawn_pg(
        commands,
        fulcrum_mesh,
        mat(materials, Color::srgb(0.5, 0.5, 0.5)),
        "Fulcrum".into(),
        Transform::from_translation(Vec3::new(0.0, 0.75 * s, 0.0)),
        PhysicsBodyType::StaticBody,
        CollisionShapeData::cuboid(Vec3::new(0.25 * s, 0.75 * s, 1.0 * s)),
        1.0,
    );
    ...
    spawn_pg(
        commands,
        plank_mesh,
        mat(materials, Color::srgb(0.6, 0.4, 0.2)),
        "Seesaw Plank".into(),
        Transform::from_translation(Vec3::new(0.0, 1.6 * s, 0.0)),
        PhysicsBodyType::RigidBody,
        CollisionShapeData::cuboid(Vec3::new(5.0 * s, 0.1 * s, 1.0 * s)),
        2.0,
    );
    ...
    for i in 0..3u32 {
        spawn_pg(
            commands,
            sphere_mesh.clone(),
            mat(materials, Color::hsl(120.0 + i as f32 * 30.0, 0.7, 0.6)),
            format!("Light Ball {}", i),
    ...
    spawn_pg(
        commands,
        heavy_mesh,
        mat(materials, Color::hsl(0.0, 0.6, 0.4)),
        "Heavy Block".into(),
...
fn spawn_marbles(
    ...
    for i in 0..segments {
        ...
        spawn_pg(
            ...
            ramp_mesh,
            ramp_mat.clone(),
            format!("Ramp Segment {}", i),
            Transform::from_translation(Vec3::new(x, y, z))
                .with_rotation(Quat::from_rotation_y(-angle) * Quat::from_rotation_z(-0.15)),
            PhysicsBodyType::StaticBody,
            CollisionShapeData::cuboid(Vec3::new(1.5 * s, 0.075 * s, 0.5 * s)),
            1.0,
        );
    }
    ...
    for i in 0..8u32 {
        ...
        spawn_pg(
            commands,
            marble_mesh.clone(),
            mat(materials, Color::hsl(hue, 0.9, 0.6)),
            format!("Marble {}", i),
            Transform::from_translation(Vec3::new(
                (i as f32 * 0.3 - 1.0) * s,
    ...
    spawn_pg(
        commands,
        bowl_mesh,
        mat(materials, Color::srgb(0.3, 0.3, 0.35)),
        "Bowl".into(),
        Transform::from_translation(Vec3::new(0.0, -1.5 * s, 0.0)),
        PhysicsBodyType::StaticBody,
        CollisionShapeData::sphere(2.0 * s),
        1.0,
    );
    ...
    for layer in 0..layers {
        ...
        for j in 0..3 {
            ...
            spawn_pg(
                ...
                block_mesh.clone(),
                m,
                format!("Jenga L{}B{}", layer, j),
                transform,
                PhysicsBodyType::RigidBody,
                CollisionShapeData::cuboid(Vec3::new(block_w * 0.5, block_h * 0.5, block_d * 0.5)),
                0.8,
            );
        }
    }
...
fn spawn_plinko(
    ...
    spawn_pg(
        commands,
        back_mesh,
        mat(materials, Color::srgb(0.15, 0.15, 0.2)),
        "Plinko Board".into(),
        Transform::from_translation(Vec3::new(0.0, board_h * 0.5, -0.5 * s)),
        PhysicsBodyType::StaticBody,
        CollisionShapeData::cuboid(Vec3::new(board_w * 0.5, board_h * 0.5, 0.1 * s)),
        1.0,
    );
    ...
    spawn_pg(
        commands,
        glass_mesh,
        mat(materials, Color::srgba(0.5, 0.5, 0.6, 0.15)),
        "Glass".into(),
        Transform::from_translation(Vec3::new(0.0, board_h * 0.5, 0.5 * s)),
        PhysicsBodyType::StaticBody,
        CollisionShapeData::cuboid(Vec3::new(board_w * 0.5, board_h * 0.5, 0.05 * s)),
        1.0,
    );
    ...
    for row in 0..peg_rows {
        ...
        for col in 0..cols {
            ...
            spawn_pg(
                ...
                PhysicsBodyType::StaticBody,
                CollisionShapeData::cylinder(0.15 * s, 0.3 * s),
                1.0,
            );
        }
    }
    ...
    for side in [-1.0f32, 1.0] {
        ...
        spawn_pg(
            ...
            PhysicsBodyType::StaticBody,
            CollisionShapeData::cuboid(Vec3::new(0.1 * s, board_h * 0.5, 0.5 * s)),
            1.0,
        );
    }
    ...
    for i in 0..5u32 {
        ...
        spawn_pg(
            commands,
            ball_mesh.clone(),
            mat(materials, Color::hsl(i as f32 * 60.0, 0.8, 0.6)),
    ...
    spawn_pg(
        ...
        PhysicsBodyType::StaticBody,
        CollisionShapeData::cuboid(Vec3::new(board_w * 0.5, 0.15 * s, 0.5 * s)),
        1.0,
    );
}
...
fn spawn_conveyor(
    ...
    for i in 0..5u32 {
        ...
        spawn_pg(
            ...
            PhysicsBodyType::StaticBody,
            CollisionShapeData::cuboid(Vec3::new(3.0 * s, 0.1 * s, 1.5 * s)),
            1.0,
        );
    }
    ...
    for i in 0..8u32 {
        ...
        if i % 2 == 0 {
            ...
            spawn_pg(
                ...
                sphere_mesh.clone(),
                m,
                format!("Conveyor Sphere {}", i),
                Transform::from_translation(Vec3::new(x, y, 0.0)),
                PhysicsBodyType::RigidBody,
                CollisionShapeData::sphere(0.35 * s),
                1.0,
            );
        }
    }
    ...
    for side in [-1.0f32, 1.0] {
        ...
        spawn_pg(
            ...
            PhysicsBodyType::StaticBody,
            CollisionShapeData::cuboid(Vec3::new(0.1 * s, 1.0 * s, 2.0 * s)),
            1.0,
        );
    }
    spawn_ground(commands, meshes, materials, s);
...
fn spawn_trebuchet(
    ...
    for side in [-1.0f32, 1.0] {
        spawn_pg(
            ...
            frame_mesh.clone(),
            frame_mat.clone(),
            "Trebuchet Frame".into(),
            Transform::from_translation(Vec3::new(-5.0 * s, 2.0 * s, side * 1.0 * s)),
            PhysicsBodyType::StaticBody,
            CollisionShapeData::cuboid(Vec3::new(0.15 * s, 2.0 * s, 0.15 * s)),
            1.0,
        );
    }
    ...
    spawn_pg(
        ...
        PhysicsBodyType::StaticBody,
        CollisionShapeData::cuboid(Vec3::new(0.15 * s, 0.15 * s, 1.25 * s)),
        1.0,
    );
    ...
    spawn_pg(
        ...
        PhysicsBodyType::RigidBody,
        CollisionShapeData::cuboid(Vec3::new(4.0 * s, 0.1 * s, 0.15 * s)),
        3.0,
    );
    ...
    spawn_pg(
        ...
        PhysicsBodyType::RigidBody,
        CollisionShapeData::cuboid(Vec3::splat(0.5 * s)),
        30.0,
    );
    ...
    spawn_pg(
        commands,
        proj_mesh,
        mat(materials, Color::hsl(30.0, 0.9, 0.5)),
        "Trebuchet Projectile".into(),
    ...
    for i in 0..9u32 {
        ...
        spawn_pg(
            commands,
            box_mesh.clone(),
            mat(materials, Color::hsl(i as f32 * 35.0, 0.7, 0.55)),
            format!("Target {}", i),
            Transform::from_translation(Vec3::new(
                10.0 * s,
                0.4 * s + row as f32 * 0.9 * s,
...
fn spawn_rube_goldberg(
    ...
    spawn_pg(
        commands,
        ramp1_mesh,
        mat(materials, Color::srgb(0.5, 0.4, 0.3)),
        "Ramp 1".into(),
        Transform::from_translation(Vec3::new(-8.0 * s, 6.0 * s, 0.0))
            .with_rotation(Quat::from_rotation_z(-0.3)),
        PhysicsBodyType::StaticBody,
        CollisionShapeData::cuboid(Vec3::new(1.5 * s, 0.075 * s, 1.0 * s)),
        1.0,
    );
    ...
    spawn_pg(
        commands,
        ball1_mesh,
        mat(materials, Color::hsl(0.0, 0.8, 0.5)),
        "Trigger Ball".into(),
    ...
    for i in 0..8u32 {
        ...
        spawn_pg(
            ...
            PhysicsBodyType::RigidBody,
            CollisionShapeData::cuboid(Vec3::new(0.05 * s, 0.4 * s, 0.2 * s)),
            0.3,
        );
    }
    ...
    spawn_pg(
        commands,
        plat_mesh.clone(),
        mat(materials, Color::srgb(0.4, 0.4, 0.4)),
        "Platform 1".into(),
        Transform::from_translation(Vec3::new(-4.0 * s, 4.0 * s, 0.0)),
        PhysicsBodyType::StaticBody,
        CollisionShapeData::cuboid(Vec3::new(3.0 * s, 0.1 * s, 1.0 * s)),
        1.0,
    );
    ...
    spawn_pg(
        commands,
        ramp2_mesh,
        mat(materials, Color::srgb(0.45, 0.35, 0.3)),
        "Ramp 2".into(),
    ...
    spawn_pg(
        ...
        PhysicsBodyType::RigidBody,
        CollisionShapeData::sphere(0.5 * s),
        5.0,
    );
    ...
    for i in 0..6u32 {
        ...
        spawn_pg(
            commands,
            box_mesh.clone(),
            mat(materials, Color::hsl(60.0 + i as f32 * 30.0, 0.6, 0.55)),
            format!("Stack Box {}", i),
            Transform::from_translation(Vec3::new(
            ...
            PhysicsBodyType::RigidBody,
            CollisionShapeData::cuboid(Vec3::splat(0.35 * s)),
            1.0,
        );
    }
    ...
    spawn_pg(
        commands,
        ramp3_mesh,
        mat(materials, Color::srgb(0.4, 0.4, 0.45)),
        "Final Ramp".into(),
        Transform::from_translation(Vec3::new(7.0 * s, 1.5 * s, 0.0))
            .with_rotation(Quat::from_rotation_z(-0.2)),
        PhysicsBodyType::StaticBody,
        CollisionShapeData::cuboid(Vec3::new(2.5 * s, 0.075 * s, 1.0 * s)),
        1.0,
    );
    ...
    for side in [-1.0f32, 1.0] {
        ...
        spawn_pg(
            ...
            PhysicsBodyType::StaticBody,
            CollisionShapeData::cuboid(Vec3::new(0.1 * s, 1.0 * s, 1.0 * s)),
            1.0,
        );
    }
...
fn spawn_waterfall(
    ...
    spawn_pg(
        ...
        PhysicsBodyType::StaticBody,
        CollisionShapeData::cuboid(Vec3::new(3.0 * s, 0.15 * s, 2.0 * s)),
        1.0,
    );
    // Stream of spheres
    ...
    for i in 0..40u32 {
        ...
        spawn_pg(
            commands,
            sphere_mesh.clone(),
            mat(materials, Color::hsl((i as f32 * 9.0) % 360.0, 0.7, 0.6)),
            format!("Drop {}", i),
            Transform::from_translation(Vec3::new(x, y, z)),
            PhysicsBodyType::RigidBody,
            CollisionShapeData::sphere(0.25 * s),
            0.5,
        );
    }
    // Catch basin
    for side in [-1.0f32, 1.0] {
        ...
        spawn_pg(
            commands,
            wall_mesh,
            mat(materials, Color::srgb(0.35, 0.35, 0.4)),
            "Basin Wall".into(),
            Transform::from_translation(Vec3::new(side * 4.0 * s, 1.5 * s, 0.0)),
            PhysicsBodyType::StaticBody,
            CollisionShapeData::cuboid(Vec3::new(0.1 * s, 1.5 * s, 3.0 * s)),
            1.0,
        );
    }
    spawn_ground(commands, meshes, materials, s);
...
fn spawn_cannon(
    ...
    spawn_pg(
        ...
        PhysicsBodyType::StaticBody,
        CollisionShapeData::cylinder(0.5 * s, 1.5 * s),
        1.0,
    );
    // Cannonball
    ...
    spawn_pg(
        commands,
        ball_mesh,
        mat(materials, Color::srgb(0.15, 0.15, 0.15)),
        "Cannonball".into(),
    ...
    for row in 0..4u32 {
        for col in 0..5u32 {
            spawn_pg(
                ...
                mat(
                    materials,
                    Color::hsl((row * 5 + col) as f32 * 12.0, 0.5, 0.55),
                ),
...
fn spawn_bridge(
    ...
    spawn_pg(
        ...
        PhysicsBodyType::StaticBody,
        CollisionShapeData::cuboid(Vec3::new(1.0 * s, 2.0 * s, 1.5 * s)),
        1.0,
    );
    spawn_pg(
        commands,
    ...
    for i in 0..8u32 {
        ...
        spawn_pg(
            commands,
            plank_mesh.clone(),
            mat(materials, Color::srgb(0.55, 0.4, 0.2)),
            format!("Plank {}", i),
            Transform::from_translation(Vec3::new(x, 4.1 * s, 0.0)),
            PhysicsBodyType::RigidBody,
            CollisionShapeData::cuboid(Vec3::new(0.6 * s, 0.075 * s, 1.5 * s)),
            2.0,
        );
    }
    ...
    for i in 0..5u32 {
        spawn_pg(
            commands,
            heavy_mesh.clone(),
            mat(materials, Color::hsl(i as f32 * 60.0, 0.7, 0.5)),
            format!("Weight {}", i),
            Transform::from_translation(Vec3::new(
                (i as f32 - 2.0) * 1.2 * s,
                6.0 * s + i as f32 * 0.8 * s,
                0.0,
            )),
            PhysicsBodyType::RigidBody,
            CollisionShapeData::cuboid(Vec3::splat(0.4 * s)),
...
fn spawn_elevator(
    ...
    for side in [-1.0f32, 1.0] {
        ...
        spawn_pg(
            ...
            PhysicsBodyType::StaticBody,
            CollisionShapeData::cuboid(Vec3::new(0.1 * s, 6.0 * s, 2.0 * s)),
            1.0,
        );
    }
    ...
    for i in 0..4u32 {
        spawn_pg(
            commands,
            plat_mesh.clone(),
            mat(materials, Color::srgb(0.3, 0.5, 0.6)),
            format!("Platform {}", i),
            Transform::from_translation(Vec3::new(0.0, 1.0 * s + i as f32 * 3.0 * s, 0.0)),
            PhysicsBodyType::StaticBody,
            CollisionShapeData::cuboid(Vec3::new(2.25 * s, 0.1 * s, 2.0 * s)),
            1.0,
        );
    }
    ...
    for i in 0..8u32 {
        ...
        if i % 3 == 0 {
            spawn_pg(
                commands,
                sphere_mesh.clone(),
                mat(materials, Color::hsl(i as f32 * 40.0, 0.7, 0.6)),
...
fn spawn_pinball_scenario(
    ...
    spawn_pg(
        commands,
        board_mesh,
        mat(materials, Color::srgb(0.15, 0.2, 0.15)),
        "Board".into(),
        Transform::from_translation(Vec3::new(0.0, 8.0 * s, -0.5 * s))
            .with_rotation(Quat::from_rotation_x(0.1)),
        PhysicsBodyType::StaticBody,
        CollisionShapeData::cuboid(Vec3::new(5.0 * s, 8.0 * s, 0.1 * s)),
        1.0,
    );
    // Bumpers
    ...
    for i in 0..3u32 {
        ...
        spawn_pg(
            commands,
            ball_mesh.clone(),
            mat(materials, Color::hsl(i as f32 * 100.0, 0.8, 0.6)),
            format!("Pinball {}", i),
    ...
    for side in [-1.0f32, 1.0] {
        ...
        spawn_pg(
            ...
            PhysicsBodyType::StaticBody,
            CollisionShapeData::cuboid(Vec3::new(0.1 * s, 8.0 * s, 0.5 * s)),
            1.0,
        );
    }
    spawn_ground(commands, meshes, materials, s);
...
fn spawn_spinner(
    ...
    spawn_pg(
        commands,
        arm_mesh,
        mat(materials, Color::srgb(0.5, 0.3, 0.3)),
        "Spinner Arm".into(),
        Transform::from_translation(Vec3::new(0.0, 1.5 * s, 0.0))
            .with_rotation(Quat::from_rotation_y(0.3)),
        PhysicsBodyType::RigidBody,
        CollisionShapeData::cuboid(Vec3::new(5.0 * s, 0.15 * s, 0.25 * s)),
        8.0,
    );
    ...
    for i in 0..12u32 {
        ...
        spawn_pg(
            commands,
            box_mesh.clone(),
            mat(materials, Color::hsl(i as f32 * 30.0, 0.7, 0.6)),
            format!("Target {}", i),
...
fn spawn_hourglass(
    ...
    for i in 0..segments {
        ...
        spawn_pg(
            ...
            PhysicsBodyType::StaticBody,
            CollisionShapeData::cuboid(Vec3::new(seg_w * 0.5, 0.075 * s, 2.0 * s)),
            1.0,
        );
        // Lower cone (inverted)
    ...
    for i in 0..25u32 {
        ...
        spawn_pg(
            commands,
            sphere_mesh.clone(),
            mat(materials, Color::hsl((i as f32 * 14.0) % 360.0, 0.7, 0.6)),
            format!("Grain {}", i),
            Transform::from_translation(Vec3::new(
                angle.cos() * r,
                9.0 * s + i as f32 * 0.3 * s,
                angle.sin() * r,
            )),
            PhysicsBodyType::RigidBody,
            CollisionShapeData::sphere(0.2 * s),
            0.3,
        );
    }
    spawn_ground(commands, meshes, materials, s);
...
fn spawn_mass_comparison(
    ...
    for (i, x_off) in [-3.0f32, 3.0f32].iter().enumerate() {
        spawn_pg(
            ...
            PhysicsBodyType::StaticBody,
            CollisionShapeData::cuboid(Vec3::new(1.5 * s, 0.075 * s, 4.0 * s)),
            1.0,
        );
    }
    ...
    spawn_pg(
        commands,
        light_mesh,
        mat(materials, Color::hsl(120.0, 0.7, 0.6)),
        "Light Ball (1kg)".into(),
    ...
    spawn_pg(
        commands,
        heavy_mesh,
        mat(materials, Color::hsl(0.0, 0.7, 0.5)),
        "Heavy Ball (50kg)".into(),
        Transform::from_translation(Vec3::new(3.0 * s, 6.0 * s, -3.0 * s)),
        PhysicsBodyType::RigidBody,
        CollisionShapeData::sphere(0.5 * s),
        50.0,
    ...
    for side in [-3.0f32, 3.0] {
        for j in 0..3u32 {
            spawn_pg(
                commands,
                target_mesh.clone(),
                mat(materials, Color::hsl(45.0, 0.6, 0.6)),
                format!("Target {}", j),
                Transform::from_translation(Vec3::new(
                    side * s,
                    0.3 * s,
                    3.0 * s + j as f32 * 0.7 * s,
                )),
                PhysicsBodyType::RigidBody,
                CollisionShapeData::cuboid(Vec3::splat(0.3 * s)),
                1.0,
...
fn spawn_ricochet(
    ...
    for (pos, half) in [
        (
            Vec3::new(0.0, wh * 0.5, chamber),
            Vec3::new(chamber, wh * 0.5, 0.15),
        ),
        (
            Vec3::new(0.0, wh * 0.5, -chamber),
            Vec3::new(chamber, wh * 0.5, 0.15),
        ...
        (
            Vec3::new(chamber, wh * 0.5, 0.0),
            Vec3::new(0.15, wh * 0.5, chamber),
        ),
        (
            Vec3::new(-chamber, wh * 0.5, 0.0),
            Vec3::new(0.15, wh * 0.5, chamber),
        ...
        spawn_pg(
            ...
            Transform::from_translation(pos),
            PhysicsBodyType::StaticBody,
            CollisionShapeData::cuboid(half),
            1.0,
        );
    }
    // Ceiling
    ...
    spawn_pg(
        ...
        PhysicsBodyType::StaticBody,
        CollisionShapeData::cuboid(Vec3::new(chamber, 0.1 * s, chamber)),
        1.0,
    );
    ...
    for (pos, rot) in [
        ...
        spawn_pg(
            ...
            PhysicsBodyType::StaticBody,
            CollisionShapeData::cuboid(Vec3::new(2.0 * s, 1.5 * s, 0.1 * s)),
            1.0,
        );
    }
    // Ball
    ...
    spawn_pg(
        commands,
        ball_mesh,
        mat(materials, Color::hsl(200.0, 0.8, 0.6)),
        "Ricochet Ball".into(),
            ...
            for row in 0..wall_h as u32 {
                ...
                spawn_pg(
                    ...
                    mat(
                        materials,
                        Color::hsl(
                            ((wall * wall_len as u32 * wall_h as u32 + col * wall_h as u32 + row)
                                as f32
                                * 7.0)
                                % 360.0,
                            0.5,
...
fn spawn_spiral_drop(
    ...
    for i in 0..segments {
        ...
        spawn_pg(
            ...
            PhysicsBodyType::StaticBody,
            CollisionShapeData::cuboid(Vec3::new(1.75 * s, 0.075 * s, 0.75 * s)),
            1.0,
        );
    }
    // Central column
    ...
    spawn_pg(
        ...
        PhysicsBodyType::StaticBody,
        CollisionShapeData::cylinder(0.5 * s, total_height * 0.5),
        1.0,
    );
    // Objects to drop
    let sphere_mesh = meshes.add(Sphere::new(0.3 * s));
    for i in 0..6u32 {
        spawn_pg(
            commands,
            sphere_mesh.clone(),
            mat(materials, Color::hsl(i as f32 * 55.0, 0.8, 0.6)),
            format!("Ball {}", i),
            Transform::from_translation(Vec3::new(
                (i as f32 - 2.5) * 0.7 * s,
                total_height + 2.0 * s,
...
fn spawn_trampoline(
    ...
    spawn_pg(
        commands,
        floor_mesh,
        mat(materials, Color::srgb(0.2, 0.5, 0.8)),
        "Trampoline".into(),
        Transform::from_translation(Vec3::new(0.0, -0.15 * s, 0.0)),
        PhysicsBodyType::StaticBody,
        floor_shape,
    ...
    for (pos, half) in [
        (
            Vec3::new(0.0, wh * 0.5, arena),
            Vec3::new(arena, wh * 0.5, 0.15),
        ),
        (
            Vec3::new(0.0, wh * 0.5, -arena),
            Vec3::new(arena, wh * 0.5, 0.15),
        ...
        (
            Vec3::new(arena, wh * 0.5, 0.0),
            Vec3::new(0.15, wh * 0.5, arena),
        ),
        (
            Vec3::new(-arena, wh * 0.5, 0.0),
            Vec3::new(0.15, wh * 0.5, arena),
    ...
    for i in 0..10u32 {
        ...
        if i % 2 == 0 {
            ...
            spawn_pg(
                commands,
                sphere_mesh.clone(),
                mat(materials, Color::hsl(i as f32 * 35.0, 0.8, 0.6)),
                format!("Bouncer {}", i),
                Transform::from_translation(Vec3::new(x, y, z)),
                PhysicsBodyType::RigidBody,
                shape,
    ...
    for stage in 0..stages {
        ...
        for j in 0..count {
            ...
            spawn_pg(
                commands,
                domino_mesh.clone(),
                mat(materials, Color::hsl(stage as f32 * 40.0, 0.7, 0.55)),
                format!("Stage{}D{}", stage, j),
                Transform::from_translation(Vec3::new(x + dx, h * 0.5, 0.0)).with_rotation(tilt),
                PhysicsBodyType::RigidBody,
                CollisionShapeData::cuboid(Vec3::new(w * 0.5, h * 0.5, d * 0.5)),
                scale_factor,
            );
        }
...
fn spawn_freefall(
    ...
    spawn_pg(
        commands,
        target_mesh,
        mat(materials, Color::srgb(0.8, 0.2, 0.2)),
        "Target".into(),
        Transform::from_translation(Vec3::new(0.0, 0.15 * s, 0.0)),
        PhysicsBodyType::StaticBody,
        CollisionShapeData::cuboid(Vec3::new(3.0 * s, 0.15 * s, 3.0 * s)),
        1.0,
    );
    ...
    for i in 0..15u32 {
        ...
        match i % 3 {
            ...
            _ => spawn_pg(
                ...
                Transform::from_translation(Vec3::new(x, y, z)),
                PhysicsBodyType::RigidBody,
                CollisionShapeData::capsule(0.25 * s, 0.4 * s),
                1.2,
            ),
        }
    }
...
fn spawn_slingshot(
    ...
    spawn_pg(
        ...
        PhysicsBodyType::StaticBody,
        CollisionShapeData::cuboid(Vec3::new(0.15 * s, 1.5 * s, 0.15 * s)),
        1.0,
    );
    ...
    for side in [-1.0f32, 1.0] {
        spawn_pg(
            ...
            PhysicsBodyType::StaticBody,
            CollisionShapeData::cuboid(Vec3::new(0.1 * s, 1.0 * s, 0.1 * s)),
            1.0,
        );
    }
    // Projectiles
    ...
    for i in 0..3u32 {
        spawn_pg(
            commands,
            proj_mesh.clone(),
            mat(materials, Color::hsl(i as f32 * 100.0, 0.8, 0.5)),
            format!("Ammo {}", i),
    ...
    for row in 0..4u32 {
        for col in 0..4u32 {
            spawn_pg(
                ...
                mat(
                    materials,
                    Color::hsl((row * 4 + col) as f32 * 20.0, 0.6, 0.6),
                ),
...
fn shape_mesh_and_collider(shape: PlaygroundShape) -> (Mesh, CollisionShapeData) {
    match shape {
        ...
        PlaygroundShape::Capsule => (
            Capsule3d::new(0.3, 1.0).into(),
            CollisionShapeData::capsule(0.3, 0.5),
        ),
        PlaygroundShape::Cylinder => (
            Cylinder::new(0.4, 1.0).into(),
            CollisionShapeData::cylinder(0.4, 0.5),
        ),
    }
}
...
fn generate_positions(pattern: SpawnPattern, count: u32, height: f32) -> Vec<Vec3> {
    ...
    match pattern {
        ...
        SpawnPattern::Explosion => (0..count)
            .map(|i| {
...
fn spawn_ground(
    ...
    spawn_pg(
        ...
        mesh,
        material,
        "Scenario Ground".into(),
        Transform::from_translation(Vec3::new(0.0, -0.05, 0.0)),
        PhysicsBodyType::StaticBody,
        CollisionShapeData::cuboid(Vec3::new(25.0 * s, 0.05, 25.0 * s)),
        1.0,
    );
}
...
fn spawn_domino_chain(
    ...
    for i in 0..20 {
        ...
        spawn_pg(
            ...
            PhysicsBodyType::RigidBody,
            CollisionShapeData::cuboid(Vec3::new(0.05 * s, 0.5 * s, 0.25 * s)),
            0.5,
        );
    }
    spawn_ground(commands, meshes, materials, s);
...
fn spawn_inclined_plane(
    ...
    spawn_pg(
        commands,
        ramp_mesh,
        mat(materials, Color::srgb(0.6, 0.6, 0.6)),
        "Ramp".into(),
        Transform::from_translation(Vec3::new(0.0, 3.0 * s, 0.0))
    ...
    spawn_pg(
        commands,
        box_mesh,
        mat(materials, Color::hsl(240.0, 0.7, 0.5)),
        "Ramp Box".into(),
...
fn spawn_avalanche(
    ...
    spawn_pg(
        commands,
        slope_mesh,
        mat(materials, Color::srgb(0.45, 0.4, 0.35)),
        "Slope".into(),
        Transform::from_translation(Vec3::new(0.0, 5.0 * s, 0.0))
            .with_rotation(Quat::from_rotation_x(0.6)),
        PhysicsBodyType::StaticBody,
        CollisionShapeData::cuboid(Vec3::new(4.0 * s, 0.15 * s, 4.0 * s)),
        1.0,
    );
...
fn spawn_wrecking_ball(
    ...
    for row in 0..5 {
        for col in 0..4 {
            spawn_pg(
                ...
                format!("Wall {},{}", row, col),
                Transform::from_translation(Vec3::new(
                    (col as f32 - 1.5) * 1.1 * s,
                    0.5 * s + row as f32 * 1.1 * s,
                    0.0,
                )),
                PhysicsBodyType::RigidBody,
                CollisionShapeData::cuboid(Vec3::splat(0.5 * s)),
    ...
    spawn_pg(
        ...
        Transform::from_translation(Vec3::new(-8.0 * s, 6.0 * s, 0.0)),
        PhysicsBodyType::RigidBody,
        CollisionShapeData::sphere(1.5 * s),
        50.0,
    );
    spawn_ground(commands, meshes, materials, s);
}
...
fn spawn_newtons_cradle(
    ...
    spawn_pg(
        ...
        PhysicsBodyType::StaticBody,
        CollisionShapeData::cuboid(Vec3::new(spacing * 3.0, 0.1 * s, 0.1 * s)),
        1.0,
    );
}
...
fn spawn_pendulum(
    ...
    spawn_pg(
        ...
        anchor_mesh,
        mat(materials, Color::srgb(0.5, 0.5, 0.5)),
        "Pendulum Anchor".into(),
        Transform::from_translation(Vec3::new(0.0, 8.0 * s, 0.0)),
        PhysicsBodyType::StaticBody,
        CollisionShapeData::cuboid(Vec3::splat(0.15 * s)),
        1.0,
    );
    ...
    spawn_pg(
        commands,
        bob_mesh,
        mat(materials, Color::hsl(280.0, 0.7, 0.6)),
        "Pendulum Bob".into(),
        Transform::from_translation(Vec3::new(4.0 * s, 5.0 * s, 0.0)),
        PhysicsBodyType::RigidBody,
        CollisionShapeData::sphere(0.6 * s),
        2.0,
    );
    spawn_ground(commands, meshes, materials, s);
}
...
fn spawn_projectile(
    ...
    spawn_pg(
        ...
        PhysicsBodyType::StaticBody,
        CollisionShapeData::cuboid(Vec3::new(0.25 * s, 2.0 * s, 2.0 * s)),
        1.0,
    );
    spawn_ground(commands, meshes, materials, s);
}
...
fn spawn_gauntlet(
    ...
    spawn_pg(
        ...
        plat_mesh.clone(),
        plat_mat.clone(),
        "Gauntlet Ramp 1".into(),
        Transform::from_translation(Vec3::new(-6.0 * s, 4.0 * s, 0.0))
            .with_rotation(Quat::from_rotation_z(-0.3)),
        PhysicsBodyType::StaticBody,
        CollisionShapeData::cuboid(Vec3::new(3.0 * s, 0.15 * s, 1.5 * s)),
        1.0,
    );
    spawn_pg(
        commands,
    ...
    spawn_pg(
        commands,
        ball_mesh,
        mat(materials, Color::hsl(180.0, 0.8, 0.5)),
        "Gauntlet Ball".into(),
        Transform::from_translation(Vec3::new(-8.0 * s, 6.0 * s, 0.0)),
        PhysicsBodyType::RigidBody,
        CollisionShapeData::sphere(0.5 * s),
...
fn spawn_wedge_stress(
    ...
    spawn_pg(
        ...
        PhysicsBodyType::StaticBody,
        CollisionShapeData::cuboid(Vec3::new(0.1 * s, 1.5 * s, 4.0 * s)),
        1.0,
    );
    spawn_pg(
        commands,
    ...
    spawn_pg(
        ...
        corner_wall,
        wall_mat.clone(),
        "Corner Back Wall".into(),
        Transform::from_translation(Vec3::new(3.0 * s, 1.5 * s, -3.0 * s)),
        PhysicsBodyType::StaticBody,
        CollisionShapeData::cuboid(Vec3::new(3.0 * s, 1.5 * s, 0.1 * s)),
        1.0,
    );
    spawn_pg(
        commands,
    ...
    spawn_pg(
        ...
        PhysicsBodyType::StaticBody,
        CollisionShapeData::cuboid(Vec3::new(0.1 * s, 1.0 * s, 5.0 * s)),
        1.0,
    );
    spawn_pg(
        commands,
    ...
    spawn_pg(
        ...
        PhysicsBodyType::StaticBody,
        CollisionShapeData::cuboid(Vec3::new(2.0 * s, 1.0 * s, 0.1 * s)),
        1.0,
    );
    ...
    for i in 0..8 {
        ...
        let m = mat(
            materials,
            Color::hsl((i as f32 * 40.0 + 120.0) % 360.0, 0.8, 0.55),
        );
        if i % 2 == 0 {
            spawn_pg(
                commands,
...
fn spawn_walled_arena(
    ...
    spawn_arena_static(
        commands,
        meshes.add(Cuboid::new(arena * 2.0, 0.5, arena * 2.0)),
        wall_mat.clone(),
        "Floor".into(),
    ...
    for (pos, rot) in [
        ...
        spawn_arena_static(
            commands,
            meshes.add(Cuboid::new(rl, 0.3, rw)),
            ramp_mat.clone(),
            "Ramp".into(),
    ...
    for i in 0..8u32 {
        ...
        if i % 2 == 0 {
            spawn_arena_static(
                commands,
                meshes.add(Cylinder::new(0.8 * s, 3.0 * s)),
                obs_mat.clone(),
                format!("Pillar {}", i),
                Transform::from_translation(pos),
            ...
            spawn_arena_static(
                commands,
                meshes.add(Cuboid::new(1.5 * s, 2.0 * s, 1.5 * s)),
                obs_mat.clone(),
                format!("Obstacle {}", i),
                Transform::from_translation(pos),
                CollisionShapeData::cuboid(Vec3::splat(0.75 * s)),
...
fn spawn_stair_fall(
    ...
    for i in 0..step_count {
        ...
        spawn_arena_static(
            commands,
            meshes.add(Cuboid::new(step_w, step_h, step_d)),
            stair_mat.clone(),
            format!("Step {}", i),
            Transform::from_translation(Vec3::new(0.0, y + step_h * 0.5, z)),
    ...
    for side in [-1.0f32, 1.0] {
        spawn_arena_static(
            commands,
            meshes.add(Cuboid::new(0.3, 2.0 * s, rail_len)),
            rail_mat.clone(),
            "Rail".into(),
            Transform::from_translation(Vec3::new(
                side * step_w * 0.5,
    ...
    spawn_arena_static(
        commands,
        meshes.add(Cuboid::new(step_w * 1.5, 0.5, step_w)),
        stair_mat,
        "Landing".into(),
...
fn spawn_moving_platforms(
    ...
    for i in 0..6u32 {
        ...
        spawn_arena_static(
            commands,
            meshes.add(Cuboid::new(pw, 0.4, pd)),
            plat_mat.clone(),
            format!("Platform {}", i),
...
fn spawn_hill_slide(
    ...
    spawn_arena_static(
        commands,
        meshes.add(Cuboid::new(hill_w, 0.5, slope_len)),
        hill_mat.clone(),
        "Slope".into(),
    ...
    spawn_arena_static(
        commands,
        meshes.add(Cuboid::new(hill_w * 1.5, 0.5, hill_w)),
        hill_mat,
        "Landing".into(),
    ...
    for side in [-1.0f32, 1.0] {
        spawn_arena_static(
            commands,
            meshes.add(Cuboid::new(0.3, 1.5 * s, slope_len)),
            wall_mat.clone(),
            "Rail".into(),
            Transform::from_translation(Vec3::new(
                side * hill_w * 0.5,
                slope_rise * 0.5 + 0.75 * s,
                0.0,
            ))
            .with_rotation(Quat::from_rotation_x(-slope_angle)),
...
fn spawn_pinball_arena(
    ...
    spawn_arena_static(
        commands,
        meshes.add(Cuboid::new(board_w, board_h, 0.1)),
        glass_mat,
        "Glass".into(),
    ...
    for side in [-1.0f32, 1.0] {
        spawn_arena_static(
            commands,
            meshes.add(Cuboid::new(0.3, board_h, 2.0 * s)),
            wall_mat.clone(),
            "Side".into(),
            Transform::from_translation(Vec3::new(side * board_w * 0.5, board_h * 0.5, 0.0))
                .with_rotation(Quat::from_rotation_x(tilt)),
    ...
    spawn_arena_static(
        commands,
        meshes.add(Cuboid::new(board_w, 0.5, 2.0 * s)),
        wall_mat,
        "Bottom".into(),
        Transform::from_translation(Vec3::new(0.0, 0.25, 0.0)),
    ...
    for i in 0..10u32 {
        ...
        spawn_arena_static(
            commands,
            meshes.add(Cylinder::new(0.6 * s, 1.5 * s)),
            bumper_mat.clone(),
            format!("Bumper {}", i),
    ...
    for (pos, angle) in [
        ...
        spawn_arena_static(
            commands,
            meshes.add(Cuboid::new(board_w * 0.2, 0.2, 1.2 * s)),
            defl_mat.clone(),
            "Deflector".into(),
            Transform::from_translation(pos)
...
fn spawn_golf_course(
    ...
    spawn_arena_static(
        commands,
        meshes.add(Cuboid::new(course_w, 0.5, course_len)),
        green_mat.clone(),
        "Fairway".into(),
        Transform::from_translation(Vec3::new(0.0, -0.25, 0.0)),
    ...
    for i in 0..3u32 {
        ...
        spawn_arena_static(
            commands,
            meshes.add(Cuboid::new(3.0 * s, 0.1, 3.0 * s)),
            sand_mat.clone(),
            format!("Sand Trap {}", i),
    ...
    for side in [-1.0f32, 1.0] {
        spawn_arena_static(
            commands,
            meshes.add(Cuboid::new(0.3, 1.5 * s, course_len)),
            wall_mat.clone(),
            "Fence".into(),
            Transform::from_translation(Vec3::new(side * course_w * 0.5, 0.75 * s, 0.0)),
    ...
    for side in [-1.0f32, 1.0] {
        spawn_arena_static(
            commands,
            meshes.add(Cuboid::new(course_w, 1.5 * s, 0.3)),
            wall_mat.clone(),
            "End Wall".into(),
            Transform::from_translation(Vec3::new(0.0, 0.75 * s, side * course_len * 0.5)),
            CollisionShapeData::cuboid(Vec3::new(course_w * 0.5, 0.75 * s, 0.15)),
        );
    }
}

fn spawn_funnel_arena(
    commands: &mut Commands,
    meshes: &mut Assets<Mesh>,
    materials: &mut Assets<StandardMaterial>,
    s: f32,
    ...
    for i in 0..segments {
        ...
        spawn_arena_static(
            commands,
            meshes.add(Cuboid::new(segment_w, 0.2, slope_len)),
            funnel_mat.clone(),
    ...
    spawn_arena_static(
        commands,
        meshes.add(Cuboid::new(inner_r * 4.0, 0.5, inner_r * 4.0)),
        floor_mat,
        "Collection Floor".into(),
        Transform::from_translation(Vec3::new(0.0, -0.25, 0.0)),
    ...
    for i in 0..segments {
        ...
        spawn_arena_static(
            commands,
            meshes.add(Cuboid::new(segment_w, 3.0 * s, 0.5)),
            funnel_mat.clone(),
            format!("Rim {}", i),
...
fn spawn_colosseum(
    ...
    spawn_arena_static(
        commands,
        floor_mesh,
        arena_mat(materials, Color::srgb(0.4, 0.35, 0.3)),
        "Arena Floor".into(),
        Transform::from_translation(Vec3::new(0.0, -0.25, 0.0)),
...
fn spawn_maze(
    ...
    spawn_arena_static(
        commands,
        floor_mesh,
        arena_mat(materials, Color::srgb(0.3, 0.3, 0.35)),
        "Floor".into(),
        Transform::from_translation(Vec3::new(0.0, -0.25, 0.0)),
...
fn spawn_halfpipe(
    ...
    for i in 0..segments {
        let angle =
            (i as f32 / (segments - 1) as f32) * std::f32::consts::PI - std::f32::consts::FRAC_PI_2;
...
fn spawn_canyon(
    ...
    for i in 0..segments {
        ...
        for side in [-1.0f32, 1.0] {
            ...
            let wall_mesh = meshes.add(Cuboid::new(
                3.0 * s,
                wall_h,
                canyon_len / segments as f32 * 1.1,
            ));
            spawn_arena_static(
                commands,
                wall_mesh,
                ...
                CollisionShapeData::cuboid(Vec3::new(
                    1.5 * s,
                    wall_h * 0.5,
                    canyon_len / segments as f32 * 0.55,
                )),
            );
        }
    }
    ...
    spawn_arena_static(
        commands,
        floor_mesh,
        arena_mat(materials, Color::srgb(0.4, 0.3, 0.2)),
        "Canyon Floor".into(),
        Transform::from_translation(Vec3::new(0.0, -0.25, 0.0)),
...
fn spawn_fortress(
    ...
    for (pos, half) in [
        (
            Vec3::new(0.0, wall_h * 0.5, fort_size),
            Vec3::new(fort_size, wall_h * 0.5, 0.3 * s),
        ),
        (
            Vec3::new(0.0, wall_h * 0.5, -fort_size),
            Vec3::new(fort_size, wall_h * 0.5, 0.3 * s),
        ...
        (
            Vec3::new(fort_size, wall_h * 0.5, 0.0),
            Vec3::new(0.3 * s, wall_h * 0.5, fort_size),
        ),
        (
            Vec3::new(-fort_size, wall_h * 0.5, 0.0),
            Vec3::new(0.3 * s, wall_h * 0.5, fort_size),
    ...
    spawn_arena_static(
        commands,
        floor_mesh,
        arena_mat(materials, Color::srgb(0.35, 0.32, 0.3)),
        "Courtyard".into(),
        Transform::from_translation(Vec3::new(0.0, -0.25, 0.0)),
...
fn spawn_spiral_arena(
    ...
    spawn_arena_static(
        commands,
        col_mesh,
        arena_mat(materials, Color::srgb(0.35, 0.35, 0.4)),
        "Column".into(),
        Transform::from_translation(Vec3::new(0.0, total_height * 0.5, 0.0)),
...
fn spawn_ice_rink(
    ...
    spawn_arena_static(
        commands,
        floor_mesh,
        arena_mat(materials, Color::srgb(0.7, 0.85, 0.95)),
        "Ice Floor".into(),
        Transform::from_translation(Vec3::new(0.0, -0.25, 0.0)),
        floor_shape,
    );
    ...
    spawn_arena_static(
        commands,
        circle_mesh,
        arena_mat(materials, Color::srgb(0.3, 0.3, 0.8)),
        "Center Circle".into(),
        Transform::from_translation(Vec3::new(0.0, 0.05 * s, 0.0)),
...
fn spawn_volcano(
        ...
        for seg in 0..segments {
            ...
            spawn_arena_static(
                ...
                Transform::from_translation(Vec3::new(x, y, z)).with_rotation(
                    Quat::from_rotation_y(-angle) * Quat::from_rotation_x(slope_angle),
                ),
                CollisionShapeData::cuboid(Vec3::new(
                    seg_w * 0.5,
                    0.1 * s,
                    ring_depth.min(4.0 * s) * 0.5,
                )),
            );
        }
    }
    ...
    for seg in 0..segments {
        ...
        spawn_arena_static(
            commands,
            rim_mesh,
            arena_mat(materials, Color::srgb(0.4, 0.3, 0.25)),
            format!("Rim {}", seg),
    ...
    spawn_arena_static(
        commands,
        floor_mesh,
        arena_mat(materials, Color::srgb(0.3, 0.28, 0.25)),
        "Ground".into(),
        Transform::from_translation(Vec3::new(0.0, -0.25, 0.0)),
