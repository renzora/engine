        ...
        .show(ui, |ui| {
            egui::ScrollArea::vertical().show(ui, |ui| {
                ...
                egui::Grid::new("energy_grid")
                    ...
                    .show(ui, |ui| {
                        ui.label(
                            RichText::new("Kinetic")
                                .size(10.0)
                                .color(theme.text.secondary.to_color32()),
                        );
                        ui.label(
                            RichText::new(format!("{:.1} J", state.total_kinetic_energy))
                                .size(10.0)
                                .color(theme.text.primary.to_color32())
                                .monospace(),
                        );
                        ...
                        ui.label(
                            RichText::new(format!("{:.1} J", state.total_potential_energy))
                                .size(10.0)
                                .color(theme.text.primary.to_color32())
                                .monospace(),
                        );
                        ...
                        ui.label(
                            RichText::new(format!("{:.1} J", state.total_energy))
                                .size(10.0)
                                .color(theme.text.primary.to_color32())
                                .monospace()
                                .strong(),
                ...
                ui.horizontal(|ui| {
                    ...
                    ui.add_space(8.0);
                    ui.label(
                        RichText::new(format!("{} active", state.active_bodies))
                            .size(10.0)
                            .color(Color32::from_rgb(100, 200, 100)),
                    );
                    ui.label(
                        RichText::new(format!("{} sleeping", state.sleeping_bodies))
                            .size(10.0)
                ...
                egui::Grid::new("velocity_grid")
                    ...
                    .show(ui, |ui| {
                        ui.label(
                            RichText::new("Avg Speed")
                                .size(10.0)
                                .color(theme.text.secondary.to_color32()),
                        );
                        ui.label(
                            RichText::new(format!("{:.2} m/s", state.avg_velocity))
                                .size(10.0)
                                .color(theme.text.primary.to_color32())
                                .monospace(),
                        );
                        ui.end_row();
                        ui.label(
                            RichText::new("Max Speed")
                                .size(10.0)
                                .color(theme.text.secondary.to_color32()),
                        );
                        ui.label(
                            RichText::new(format!("{:.2} m/s", state.max_velocity))
                                .size(10.0)
                                .color(theme.text.primary.to_color32())
                                .monospace(),
                        );
                        ...
                        ui.label(
                            RichText::new(format!("{:.1}", state.total_momentum.length()))
                                .size(10.0)
                                .color(theme.text.primary.to_color32())
                                .monospace(),
                        );
                ...
                ui.horizontal(|ui| {
                    ui.label(
                        RichText::new(format!("{}", state.collision_count))
                            .size(16.0)
                            .color(theme.text.primary.to_color32())
                            .strong(),
                    );
                    ui.label(
                        RichText::new("active pairs")
                            .size(10.0)
                            .color(theme.text.muted.to_color32()),
                    );
                });
                ...
                ui.add_space(4.0);
                ui.label(
                    RichText::new(format!("{:.2} ms", state.frame_physics_time_ms))
                        .size(14.0)
                        .color(theme.text.primary.to_color32())
                        .monospace(),
                );
