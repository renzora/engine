...
pub fn render_metrics_content(ui: &mut egui::Ui, state: &mut MetricsState, theme: &Theme) {
    egui::Frame::NONE
        ...
        .show(ui, |ui| {
            egui::ScrollArea::vertical().show(ui, |ui| {
                ...
                ui.horizontal(|ui| {
                    ...
                    ui.label(RichText::new("Physics Metrics").size(13.0).color(theme.text.primary.to_color32()).strong());
                });

                ui.add_space(8.0);

                // Energy
                ui.label(RichText::new("Energy").size(12.0).color(theme.text.muted.to_color32()));
                ui.add_space(4.0);
                egui::Grid::new("energy_grid").num_columns(2).spacing([8.0, 2.0]).show(ui, |ui| {
                ...
                // Bodies
                ui.label(RichText::new("Bodies").size(12.0).color(theme.text.muted.to_color32()));
                ui.add_space(4.0);
                ...
                // Velocity & Momentum
                ui.label(RichText::new("Velocity & Momentum").size(12.0).color(theme.text.muted.to_color32()));
                ui.add_space(4.0);
                egui::Grid::new("velocity_grid").num_columns(2).spacing([8.0, 2.0]).show(ui, |ui| {
                ...
                // Collisions
                ui.label(RichText::new("Collisions").size(12.0).color(theme.text.muted.to_color32()));
                ui.add_space(4.0);
                ui.horizontal(|ui| {
                ...
                // Physics Time
                ui.label(RichText::new("Physics Time").size(12.0).color(theme.text.muted.to_color32()));
                ui.add_space(4.0);
