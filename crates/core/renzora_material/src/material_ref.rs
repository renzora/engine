...
/// Reference to a material file (`.material` for graph-authored, `.shader` for code-authored).
///
/// Add this component to any entity with a `Mesh3d` to assign a material by path.
#[derive(Component, Serialize, Deserialize, Reflect, Clone, Debug)]
