...
pub fn render_level_presets_content(
    ui: &mut egui::Ui,
    state: &mut LevelPresetsState,
    theme: &Theme,
) {
    ...
    egui::ScrollArea::vertical().show(ui, |ui| {
            ...
            for row in 0..rows {
                ui.horizontal(|ui| {
                    ...
                    for col in 0..cols {
                        ...
                        let selected = state.selected == *preset;
                        ...
                        if response.clicked() {
                            let changed = state.selected != *preset;
        ...
        ui.label(
            RichText::new("Spawns meshes, lights, and a camera as scene entities")
                .size(9.0)
                .color(text_muted)
                .italics(),
        );
