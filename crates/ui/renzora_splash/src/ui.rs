...
impl WireframeShape {
    fn random(screen_size: Vec2, seed: u64) -> Self {
        ...
        Self {
            ...
            color: Color32::from_rgb(0, 180, 180).gamma_multiply(0.35),
...
fn draw_synthwave_background(painter: &egui::Painter, screen_size: Vec2, grid_timer: f32, time: f64) {
    ...
    for i in 0..num_h_lines {
        ...
        painter.line_segment(
            [Pos2::new(0.0, y), Pos2::new(screen_size.x, y)],
...
pub fn render_splash(
    ...
    egui::CentralPanel::default()
        .frame(egui::Frame::NONE.fill(Color32::from_rgb(5, 4, 10)))
        .show(ctx, |ui| {
            ...
            render_two_column_layout(ui, app_config, commands, next_state);
        });
}

// ── Two-column layout ──────────────────────────────────────────────

/// Temp state for the new project name input
...
fn render_two_column_layout(
    ...
    ui.allocate_new_ui(egui::UiBuilder::new().max_rect(left_rect), |ui: &mut egui::Ui| {
        ui.vertical(|ui: &mut egui::Ui| {
            ui.add_space(content_height * 0.2);
            ...
            // Get/set new project name from egui temp storage
            ...
            ui.memory_mut(|mem| {
                mem.data.get_temp_mut_or_default::<NewProjectName>(egui::Id::new("splash_new_name")).0 = new_name.clone();
            });
            ...
            ui.horizontal(|ui: &mut egui::Ui| {
                ...
                let open_btn = egui::Button::new(
                    RichText::new("OPEN PROJECT").color(Color32::from_rgb(220, 220, 230))
                )
                .fill(item_bg)
                .stroke(Stroke::new(1.0, border_color))
                .corner_radius(CornerRadius::same(4))
        ...
        ui.vertical(|ui: &mut egui::Ui| {
            ...
            if app_config.recent_projects.is_empty() {
                ...
                ui.vertical_centered(|ui: &mut egui::Ui| {
                    ui.label(RichText::new("No recent projects").size(13.0).color(text_muted).italics());
                });
            } else {
