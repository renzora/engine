...
/// Tracks whether the current render frame's `begin_frame` and `acquire_image`
/// succeeded. Downstream systems (wait_image, release_image, end_frame) check
/// this to avoid submitting an inconsistent frame to the OpenXR runtime.
#[derive(Clone, Copy, Default, Resource)]
pub struct OxrFrameActive(pub bool);
