        ...
        match cmd {
            ...
            ScriptCommand::SpawnPrimitive {
                ...
                if let Some([r, g, b, a]) = color {
                    entity.insert(renzora::core::MeshColor(bevy::color::Color::srgba(
                        r, g, b, a,
                    )));
                }
            }
            ...
            ScriptCommand::SetSunAngles { azimuth, elevation } => {
                ...
                args.insert(
                    "azimuth".to_string(),
                    renzora::ScriptActionValue::Float(azimuth),
                );
                args.insert(
                    "elevation".to_string(),
                    renzora::ScriptActionValue::Float(elevation),
                );
            ...
            // === Generic Reflection ===
            ScriptCommand::SetComponentField {
                entity_id,
                entity_name,
                component_type,
                field_path,
            ...
            ScriptCommand::CharacterJump => {
                character_queue
                    .commands
                    .push((source_entity, CharacterCommand::Jump));
            }
            ScriptCommand::CharacterSprint { sprinting } => {
                character_queue
                    .commands
                    .push((source_entity, CharacterCommand::Sprint(sprinting)));
            }
...
fn script_command_to_action(
    ...
    String,
    std::collections::HashMap<String, renzora::ScriptActionValue>,
)> {
    ...
    let name = match cmd {
        ...
        ScriptCommand::SetLightIntensity {
            entity_id,
            intensity,
        } => {
            if let Some(id) = entity_id {
