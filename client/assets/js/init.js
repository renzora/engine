assets.preload([
    ...
    plugin.load({ id: 'auth_window', url: 'auth/index.njk', drag: true, reload: true });
    plugin.load({ id: 'notif', url: 'notifs/index.js', drag: false, reload: true });
    plugin.load({ id: 'context_menu', url: 'ui/menus/context_menu/index.njk', drag: false, reload: true });
    plugin.load({ id: 'ui_overlay_window', url: 'ui/hud/index.njk', drag: false, reload: true });
    plugin.load({
        id: 'weather_plugin',
    ...
    plugin.load({
        id: 'console_window',
        url: 'editor/console/index.njk',
        drag: false,
        reload: true,
        after: function () {
          plugin.load({
              id: 'edit_mode_window',
              url: 'editor/main/index.njk',
              drag: false,
              reload: true
          });
        }
