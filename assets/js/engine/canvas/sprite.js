var sprite = {
    ...
    SpritePrototype: {
        draw: function() {
            ...
            // Load images
            let headImage = assets.use('head'); 
            let hairImage = assets.use('hair'); 
            let outfitImage = assets.use('outfit');
            let facialImage = assets.use('facial'); 
            let hatImage = assets.use('hats'); 
            let glassesImage = assets.use('glasses');
            let eyesImage = assets.use('eyes'); 
            let handsImage = assets.use('hands'); 
        ...
        drawAnimal: function () {
            ...
            switch (this.animalType) {
                case 'horse':
                    animalImage = assets.use('horse'); // Load horse sprite
                    break;
                default:
