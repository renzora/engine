var sprite = {
    ...
    draw: function() {
        ...
        if (game.useWebGL && game.gl) {
            // WebGL rendering code for the sprite
            webglUtils.renderSprite(this);
        } else {
            // Existing Canvas 2D drawing code
            // Load images
            ...
            if (this.head !== 0) {
                ...
                if (this.currentFrame % 4 === 1 || this.currentFrame % 4 === 2) {
                    headY += 2; // Adjust by 2 pixels down
                }
                ...
                if (this.hat !== 0) {
                    ...
                    let hatY = headY - 6; // Adjusted to go up by 6 pixels
